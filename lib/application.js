...
Application.addServer = function ( id , info ) {
    switch ( id ) {
        case Constants.Config.CONNECTOR:
            this.addConnectorServer( info.id , info.port );
            break;
        case Constants.Config.ROOM_MANAGER:
            this.addRoomManager( info.id , info.port );
            break;
        case Constants.Config.ROOM_SERVER:
            this.addRoomServer( info.id , info.port );
            break;
        case Constants.Config.MASTER:
            this.addMaster( info.id , info.port );
            break;
    }
};
